...
void __attribute__((picinterrupt(("high_priority")))) INTERRUPT_Manager(void){
    ...
    if(INTCONbits.RBIE && INTCONbits.RBIF){
        rotary.encoderState = PORTBbits.RB4 | PORTBbits.RB5 << 1;
        if(rotary.encoderPreviousState != 0xFF ){
